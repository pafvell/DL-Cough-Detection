...
COUGH_PATH=/Users/maurice/projects/eth/deepLearning/DL-Cough-Detection/cough_detect_mobile
...
bazel-bin/tensorflow/python/tools/freeze_graph \
	...
	--input_checkpoint="$COUGH_PATH/checkpoints/$model_name/cv2/$last_checkpoint" \
