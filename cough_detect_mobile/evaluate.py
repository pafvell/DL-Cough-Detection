...
def test(
    ...
    acc, sen, spe, prec, mcc, auc = classification_report(y, predictions, class_probs_list,
...
def test_cv(device,
    ...
    print('********************************************************************************')
    print('Evaluate over Everything:')
    acc, sen, spe, prec, mfcc, auc = classification_report(y, predictions, y_probs=class_probs_list,
                                                           write_aucroccurve_tofile=False)
...
def test_ensemble(model_name=control_config["model"],
    ...
    print('********************************************************************************')
    print('Evaluate over Everything:')
    acc, sen, spe, prec, mcc, auc = classification_report(y, preds_avg_vote, probs_avg_vote_cough,
                                                          write_aucroccurve_tofile=True)
...
if __name__ == '__main__':
    if  config["DEVICE_CV"]:
        ...
        print('#' * 100, "\n")
        print('#' * 100, "\n")
        print('SUMMARY RESULTS :%s'%device)
